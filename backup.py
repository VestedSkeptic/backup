...
def main():
    ...
    parser.add_argument("--i",     nargs='?', default='backup.txt',         metavar='input_file',                 help="text file containing items to back up, default is 'backup.txt'")
    parser.add_argument("--o",     nargs='?', default="backup",         metavar='output_dir',                 help="output directory, default is 'backup'")
    parser.add_argument("--p",     action='store_true',                                                         help="precheck only, don't perform actual backup")
